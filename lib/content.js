...
const SITE = {
  ...
  baseUrl: process.env.SITE_URL || 'https://imrankhanblog.netlify.app',
  locale: 'en_US',
  themeColor: '#1C2331',
  services: [
    {
...
const AFFILIATIONS = [
  {
    company: 'Promise Assets Ltd.',
    tagline: 'Committed to Build Your Asset',
    role: 'Head of Sales',
    phones: ['+8801958-063331', '+8801511-511444'],
    email: 'hos@promiseassets.com',
    facebook: 'https://facebook.com/promiseassets',
    website: 'https://www.promiseassets.com',
    address: 'Khaja Super Market (2nd–6th Floor), 07 South Kallyanpur, Mirpur Road, Dhaka-1207'
  }
];

module.exports = { SITE, IMAGES, ABOUT, CONTACT, BEC, NAV, TESTIMONIALS, PRIVACY, TERMS, AFFILIATIONS };