...
const { SITE, IMAGES, ABOUT, CONTACT, BEC, NAV } = require('./content');
...
function footer() {
  ...
  <div class="footer-bottom">
    <div class="container footer-bottom-inner">
      ...
      <p><a href="/sitemap.xml">Sitemap</a> · <a href="/robots.txt">Robots</a> · <a href="${SITE.blogSource}" target="_blank" rel="noopener">Original Blog</a> · Developed by <a href="https://artx.techvrs.com/" target="_blank" rel="noopener">Artx</a></p>
    </div>
  </div>
</footer>`;
}
...
function homePage({ posts, categories, updates }) {
  ...
  const achievementsHtml = achievements.map((a, i) => {
    ...
    if (isCxo) {
      return `<div class="achieve-card achieve-card-cxo reveal" style="--stagger:${i}">
        <div class="cxo-top">
          <div class="achieve-icon">${ICONS[a.icon]}</div>
          <strong class="achieve-value">CXO</strong>
        </div>
        <span class="achieve-label">${escapeHtml(a.label)}</span>
      </div>`;
    }
    return `<div class="achieve-card reveal"${a.numeric !== null ? ' data-count="' + a.numeric + '"' : ''} style="--stagger:${i}">
      <div class="achieve-icon">${ICONS[a.icon]}</div>
      <strong class="achieve-value ${isEmphasis ? 'text-emphasis' : ''}"${a.numeric !== null ? ' data-target="' + a.numeric + '"' : ''}>${a.numeric !== null ? '0' : escapeHtml(a.value)}</strong>
      <span class="achieve-label">${escapeHtml(a.label)}</span>
    </div>`;
  }).join('\n');
...
<!-- Achievements / Milestones — floating cards over background image -->
<section class="section section-achievements">
  ...
  <div class="achieve-bg">
    <div class="achieve-bg-image" aria-hidden="true"></div>
    <div class="achieve-bg-overlay" aria-hidden="true"></div>
    <div class="container achieve-bg-container">
